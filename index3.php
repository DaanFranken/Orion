...
<body class="w3-center">
  ...
  <!-- Navbar (sit on top) -->
  <div class="w3-top">
    <div class="w3-bar w3-white w3-wide w3-padding w3-card" style="width:100% !important;">
      <a href="#home" class="w3-bar-item" style="padding: 0;"><img src="images/orion-symbol.png" height="40"></a>
...
<header class="w3-display-container w3-wide" id="home">
  ...
  <div class="w3-display-middle w3-margin-top w3-center">
    <img id="headerLogo" src="images/orion-logo2.png" style="opacity: 1 !important;height: 180px;">
  </div>
</header>
...
<div class="w3-content w3-padding" style="max-width:1564px;">
  <div class="w3-row w3-margin-bottom">
    ...
    <div class="w3-container w3-padding-32" id="service" style="background-color: #4A7E82;position: relative;left: -80px;width: calc(100vw + 80px);">
      <h3 class="w3-padding-16">Wat doen wij?</h3>
      <div class="w3-row" style="min-height: 250px !important" id="iconContainer">
        <div class="w3-col m12 l12">
          <figure class="item">
            <div id="webImg" class="iconImg" onclick="changeImgWeb(this);"></div>
            <figcaption class="caption"><b>Webdesign</b></figcaption>
          </figure>

          <figure class="item">
            <div id="responsiveImg" class="iconImg" onclick="changeImgResponsive(this);"></div>
            <figcaption class="caption"><b>Responsive</b></figcaption>
          </figure>

          <figure class="item">
            <div id="hostingImg" class="iconImg" onclick="changeImgHosting(this);">
            </div>
            <figcaption class="caption"><b>Hosting</b></figcaption>
          </figure>

          <figure class="item">
           <div id="appImg" class="iconImg" onclick="changeImgApp(this);">
           </div>
           <figcaption class="caption"><b>Webapplicaties</b></figcaption>
         </figure>
   ...
   <div class="w3-row">
    <div class="w3-panel">
      <p><i>          
        Nieuwsgierig geworden naar wat wij voor jou kunnen betekenen? <br/>Vul <a href="#contact">het contactformulier</a> in en we reageren zo snel mogelijk.<br/><br/> Daarnaast kun je ons altijd bellen, mailen of gewoon een appje sturen! De gegevens staan onderin op deze pagina.</i></p>
      </div>    
    </div>

    <!-- Project Section -->
    <div class="w3-container w3-padding-32" id="projects" style="position: relative;top: 100px;">
      <h3 class="w3-padding-16">Projecten</h3>
      <div class="w3-row-padding">
        <div class="w3-col l3 m6 w3-margin-bottom">
          <div class="w3-display-container">
            <div class="w3-display-topleft w3-black w3-padding">DASE-training</div>
            <a href="http://www.dasetraining.nl/" target="_blank"><img src="images/dase.png" alt="DASE" style="width:100%"></a>
          </div>
        </div>
    ...
    <!-- About Section -->
    <div class="w3-container w3-padding-32" id="about" style="position: relative;top:100px;">
      <h3 class="w3-padding-16">Wie zijn wij?</h3>
    ...
    <!-- Contact Section -->
    <div class="w3-container w3-padding-32" id="contact" style="position: relative;top:100px">
      <h3 class="w3-padding-16">Contact</h3>
      <div class="w3-row">
  ...
  <footer id="footerBar" style="text-align: left;position: relative;top:300px;">
    <p id="footer">
  ...
  <script>
 document.getElementById('webImg').style.backgroundImage = "url('images/webdesign-blauw.png')";
 document.getElementById('iconText').innerHTML = 'Een goed webdesign zorgt voor een professionele uitstraling. Maar nog belangrijker: het is een visitekaartje voor je organisatie. Een goed design dat aansluit bij je huisstijl zorgt voor een positieve eerste indruk.';
 ...
 function changeImgWeb(element)
 {
   document.getElementById('iconText').innerHTML = 'Een goed webdesign zorgt voor een professionele uitstraling. Maar nog belangrijker: het is een visitekaartje voor je organisatie. Een goed design dat aansluit bij je huisstijl zorgt voor een positieve eerste indruk.';
  element.style.backgroundImage = "url('images/webdesign-blauw.png')";
  document.getElementById('responsiveImg').style.backgroundImage = "";
  document.getElementById('hostingImg').style.backgroundImage = "";
  document.getElementById('appImg').style.backgroundImage = "";
 }
function changeImgResponsive(element)
{
   document.getElementById('iconText').innerHTML = 'Een responsive design is een ontwerp dat er op elk apparaat goed uit ziet. Dus of je site nou bekeken wordt op computer, tablet of telefoonscherm: jouw website kan elk formaat aan!';
  element.style.backgroundImage = "url('images/responsive-blauw.png')";
  document.getElementById('webImg').style.backgroundImage = "";
  document.getElementById('hostingImg').style.backgroundImage = "";
  document.getElementById('appImg').style.backgroundImage = "";
}
function changeImgHosting(element)
{
   document.getElementById('iconText').innerHTML = 'Om je website online te kunnen benaderen, moet het gekoppeld zijn aan een adres waarop het te vinden is. Daarvoor huur je als het ware een adres. Wij kunnen dit voor een aantrekkelijk tarief allemaal voor je regelen, zodat je zelf niks meer hoeft te doen!';
  element.style.backgroundImage = "url('images/domein-blauw.png')";
  document.getElementById('webImg').style.backgroundImage = "";
  document.getElementById('responsiveImg').style.backgroundImage = "";
  document.getElementById('appImg').style.backgroundImage = "";
}
function changeImgApp(element)
{
   document.getElementById('iconText').innerHTML = 'Als je aan een \'gewone\' site niet genoeg hebt, maken wij ook webapplicaties op maat. Klanten, voorraden, leden, in- en verkoop...Het maakt niet uit wat je wilt beheren, wij zorgen ervoor dat het makkelijk en overzichtelijk wordt via een op maat gemaakte webapplicatie!';
  element.style.backgroundImage = "url('images/app-blauw.png')";
  document.getElementById('webImg').style.backgroundImage = "";
  document.getElementById('responsiveImg').style.backgroundImage = "";
  document.getElementById('hostingImg').style.backgroundImage = "";
}
